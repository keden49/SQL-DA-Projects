...
-- total quantity sold per product category having more than 50
...
-- number of orders by each customer having more than 3 orders 
...
-- average unit prices greater than 20
SELECT category, AVG(unit_price) AS avg_unit_price
FROM products
GROUP BY category
HAVING avg_unit_price > 20;
